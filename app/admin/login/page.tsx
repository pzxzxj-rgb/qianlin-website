...
export default async function AdminLoginPage() {
  ...
  return <main className="admin-login-page"><section className="admin-login-card"><Link className="admin-login-brand" href="/"><span className="brand-mark">Q</span><span><strong>QIANLIN TRAVEL</strong><small>黔林旅行社</small></span></Link><span className="eyebrow">ADMIN ACCESS</span><h1>登录管理后台</h1><p>仅限黔林旅行社管理员查看站点资料和运营概况。</p><AdminLoginForm /><Link className="admin-back-link" href="/">返回官网</Link></section></main>;
}
