...
export default async function AdminPage() {
  ...
  try {
    ...
    return <main className="admin-page"><div className="admin-error-card"><span className="eyebrow">ADMIN</span><h1>后台资料暂时无法加载</h1><p>请稍后重试。如果问题持续，请检查后台运行配置。</p><Link className="button button-dark" href="/admin/login">返回登录</Link></div></main>;
  }
