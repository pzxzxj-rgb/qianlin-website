...
export async function generateMetadata({ params }: TenantPageProps): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      openGraph: { title: siteConfig.profile.companyName.en || tenant.name.en, description: siteConfig.profile.description.en || siteConfig.profile.primaryRegion.en, url: `${siteUrl}${path}`, type: "website" },
