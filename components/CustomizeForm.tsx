...
type CustomizeFormProps = { open: boolean; initialTourName?: string; onOpen: () => void; onClose: () => void };

function getChinaDate() {
  return new Intl.DateTimeFormat("en-CA", { timeZone: "Asia/Shanghai" }).format(new Date());
}

export function CustomizeForm({ open, initialTourName = "", onOpen, onClose }: CustomizeFormProps) {
