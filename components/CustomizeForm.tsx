...
type CustomizeFormProps = { open: boolean; initialTourName?: string; initialPlaces?: string; initialMessage?: string; onOpen: () => void; onClose: () => void };

function getChinaDate() {
  return new Intl.DateTimeFormat("en-CA", { timeZone: "Asia/Shanghai" }).format(new Date());
}

export function CustomizeForm({ open, initialTourName = "", initialPlaces = "", initialMessage = "", onOpen, onClose }: CustomizeFormProps) {
