...
type ToursProps = { tours: Tour[]; onBook: () => void };
  ...
  return (
    <section id="tours" className="section section-tours">
      <div className="container">
        <div className="section-row section-row-start"><SectionHeading eyebrow={t.tours.eyebrow} title={t.tours.title} description={t.tours.description} /><a href="#customize" className="text-link">{t.tours.seeAll} <span aria-hidden="true">↗</span></a></div>
