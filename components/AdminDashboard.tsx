...
export function AdminDashboard({ data }: { data: AdminDashboardData }) {
  ...
  return <main className="admin-page">
    ...
    <div className="admin-shell">
      ...
      <p className="admin-readonly-note">本页面不会展示完整咨询留言，也不会提供资料修改、删除或咨询详情操作。</p>
    </div>
  </main>;
}
