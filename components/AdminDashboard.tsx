...
export function AdminDashboard({ data }: { data: AdminDashboardData }) {
  ...
  return <main className="admin-page">
    ...
    <div className="admin-shell">
      <div className="admin-heading"><div><span className="eyebrow">QIANLIN TRAVEL · ADMIN</span><h1>旅行社管理后台</h1><p>当前版本提供资料和运营概况只读查看。</p></div><Link className="button button-light admin-site-link" href="/">查看官网 <span aria-hidden="true">→</span></Link></div>
