  ...
  return <section id="about" className="section section-about">
    <div className="container about-layout">
      <div className="about-image-wrap">
        {siteConfig.profile.images.about.src ? <Image src={siteConfig.profile.images.about.src} alt={siteConfig.profile.images.about.alt[language]} width={900} height={1200} sizes="(max-width: 760px) 100vw, 50vw" loading="lazy" onError={(event) => { event.currentTarget.hidden = true; }} /> : null}
